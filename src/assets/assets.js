...
// ✅ Fetch food list dynamically (correct way)
export const fetchFoodList = async () => {
    try {
        console.log("API URL: ", a);
        const response = await fetch(`${a}/food/get-all-food`);
        const data = await response.json();
        console.log("Fetched food list:", data.data);
        return data.data;
    } catch (error) {
